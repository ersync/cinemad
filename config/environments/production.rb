...
Rails.application.configure do
  ...
  # Set default URL options for controllers and mailers
  ...
  config.log_level = :info  # Changed from :debug to :info for production
  ...
  # config.active_job.queue_name_prefix = "cinemad_production"
